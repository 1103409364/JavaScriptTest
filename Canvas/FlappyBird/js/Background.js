(function () {
    ...
    Background.prototype.render = function () {
        // 绘制背景,铺满画布
        game.ctx.drawImage(this.image, 0, 0, this.realW, this.realH, this.x, this.y, this.width, this.height);
        game.ctx.drawImage(this.image, 0, 0, this.realW, this.realH, this.x + this.width - 1, this.y, this.width, this.height);
