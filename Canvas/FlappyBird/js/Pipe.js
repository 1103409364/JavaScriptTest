(function () {
  var Pipe = (window.Pipe = function () {
    ...
    this.pipeUpHeight =
      game.canvas.height * 0.76 - this.gap - this.pipeDownHeight;
    // 速度和大地一样
    this.speed = 2;
  ...
  Pipe.prototype.render = function () {
    ...
    game.ctx.drawImage(
      ...
      0,
      this.imageRealW,
      this.pipeUpHeight / (this.width / this.imageRealW),
      this.x,
    ...
    game.ctx.drawImage(
      ...
      0,
      this.imageRealW,
      this.pipeDownHeight / (this.width / this.imageRealW),
      0,
      0,
      this.width,
      this.pipeDownHeight
  ...
  Pipe.prototype.check = function () {
    ...
    if (game.bird.R > this.x && game.bird.L < this.x + this.width) {
      if (
        game.bird.T < this.pipeDownHeight ||
        game.bird.B > this.pipeDownHeight + this.gap
      ) {
        game.bird.goDie();
        game.sm.enter(4);
      }
